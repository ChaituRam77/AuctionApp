...
public class Constants {
    ...
    public static final String BASE_PRICE_CONST = "baseprice";
    public static final String BASE_PRICE_UNDER_CONST = "baseprice_";
    public static final String OWNER_CONST = "owners";
    ...
    public static final int PRICE5_CONST = 5;
    public static final int PRICE10_CONST = 10;
